...
use HaitiPayAcceptorAPILib\Controllers\OAuthAuthorizationController;
...
class OAuthManager
{
     ...
     * @return \HaitiPayAcceptorAPILib\Models\OAuthToken
     */
    ...
    public function checkAuthorization()
    {
        ...
        if (Configuration::$oAuthToken == null || $this->isTokenExpired()) {
            $this->authorize();
            return;
        }
    }
     ...
     * @param  \HaitiPayAcceptorAPILib\Models\OAuthToken $oAuthToken OAuth token
     */
