 ...
 */
class AmountInput implements JsonSerializable
{
    /**
    ...
    /**
     * @todo Write general description for this property
     * @var \HaitiPayAcceptorAPILib\Models\Amount|null $value public property
     */
    public $value;

    /**
     * @todo Write general description for this property
     * @var array|null $currencies public property
     */
    public $currencies;
     ...
     * @param Amount $value       Initialization value for $this->value
     * @param array  $currencies  Initialization value for $this->currencies
     */
    public function __construct()
    {
        switch (func_num_args()) {
            case 9:
                ...
                $this->currencies  = func_get_arg(8);
                break;
