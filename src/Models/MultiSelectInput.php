 ...
 */
class MultiSelectInput implements JsonSerializable
{
    /**
    ...
    /**
     * @todo Write general description for this property
     * @var array|null $value public property
     */
    public $value;

    /**
     * @todo Write general description for this property
     * @var \HaitiPayAcceptorAPILib\Models\Option[]|null $values public property
     */
    public $values;
     ...
     * @param array  $value       Initialization value for $this->value
