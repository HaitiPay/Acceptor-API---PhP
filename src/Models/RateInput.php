 ...
 */
class RateInput implements JsonSerializable
{
    /**
    ...
    /**
     * @todo Write general description for this property
     * @var \HaitiPayAcceptorAPILib\Models\Inputs|null $inputs public property
     */
    public $inputs;
     ...
     * @param Inputs $inputs      Initialization value for $this->inputs
     */
