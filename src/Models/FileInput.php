 ...
 */
class FileInput implements JsonSerializable
{
    /**
    ...
    /**
     * @todo Write general description for this property
     * @var \HaitiPayAcceptorAPILib\Models\Value|null $value public property
     */
    public $value;

    /**
     * @todo Write general description for this property
     * @var integer|null $maxsize public property
     */
    public $maxsize;

    /**
     * @todo Write general description for this property
     * @var array|null $acceptedtypes public property
     */
     ...
     * @param Value   $value         Initialization value for $this->value
     * @param integer $maxsize       Initialization value for $this->maxsize
     * @param array   $acceptedtypes Initialization value for $this->acceptedtypes
     */
    public function __construct()
    {
        switch (func_num_args()) {
            case 10:
                ...
                $this->maxsize       = func_get_arg(8);
                $this->acceptedtypes = func_get_arg(9);
                break;
    ...
    public function jsonSerialize()
    {
        ...
        $json['acceptedtypes'] = $this->acceptedtypes;
