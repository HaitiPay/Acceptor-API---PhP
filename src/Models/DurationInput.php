 ...
 */
class DurationInput implements JsonSerializable
{
    /**
    ...
    /**
     * @todo Write general description for this property
     * @var \HaitiPayAcceptorAPILib\Models\Duration|null $value public property
     */
    public $value;

    /**
     * @todo Write general description for this property
     * @var array|null $periodicities public property
     */
     ...
     * @param Duration $value         Initialization value for $this->value
     * @param array    $periodicities Initialization value for $this->periodicities
     */
    public function __construct()
    {
        switch (func_num_args()) {
            case 9:
                ...
                $this->periodicities = func_get_arg(8);
                break;
    ...
    public function jsonSerialize()
    {
        ...
        $json['periodicities'] = $this->periodicities;
